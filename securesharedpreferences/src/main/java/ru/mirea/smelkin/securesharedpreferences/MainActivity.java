package ru.mirea.smelkin.securesharedpreferences;
...
import ru.mirea.smelkin.securesharedpreferences.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            binding.editTextText.setText(secureSharedPreferences.getString("author", "null"));
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finalSecureSharedPreferences.edit().putString("author", binding.editTextText.getText().toString()).apply();
